...
class DevConfig(object):
    ...
    MARKETING_DASHBOARD         = os.environ.get("MARKETING_DASHBOARD")
    CREDITCARD_DASHBOARD        = os.environ.get("CREDITCARD_DASHBOARD")
...
class ProductionConfig(object):
    ...
    # MAIL_BACKEND                = 'file'
    # MAIL_FILE_PATH              = 'backend/flask_app/temp/app-messages'
    HTML_BUILD_DIR              = os.environ.get("HTML_BUILD_DIR")
